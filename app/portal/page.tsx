    ...
    <main className="min-h-screen bg-gradient-to-br from-pink-100 via-yellow-100 to-cyan-100">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <h2 className="text-5xl font-bungee text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500 mb-4 drop-shadow-lg">{typeLabel}</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative p-8 text-center">
              ...
              <h3 className="text-4xl font-bungee text-purple-600 mb-3 drop-shadow-md">Buy</h3>
          ...
          >
            ...
            <div className="relative p-8 text-center">
              <div className="text-7xl mb-4">💰</div>
              <h3 className="text-4xl font-bungee text-green-600 mb-3 drop-shadow-md">Sell</h3>
              <p className="text-gray-700 mb-6 text-lg font-medium">
