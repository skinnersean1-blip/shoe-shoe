  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-pink-100 via-yellow-100 to-cyan-100">
      ...
      <header className="p-6 flex justify-between items-center">
        <Link href="/" className="text-4xl font-luckiest-guy text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500 hover:from-pink-600 hover:via-purple-600 hover:to-cyan-600 transition drop-shadow-lg">
          ← Shoe Shoe
        </Link>
      </header>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <h2 className="text-5xl font-luckiest-guy text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-500 mb-4 drop-shadow-lg">{typeLabel}</h2>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative p-8 text-center">
              ...
              <h3 className="text-4xl font-luckiest-guy text-purple-600 mb-3 drop-shadow-md">Buy</h3>
              <p className="text-gray-700 mb-6 text-lg font-medium">
                Browse available {typeLabel.toLowerCase()} and make a purchase!
              </p>
              <div className="inline-block px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full font-quicksand font-bold text-lg group-hover:from-purple-600 group-hover:to-pink-600 transition shadow-lg">
                Browse Inventory →
              </div>
            </div>
          </Link>
          ...
          >
            ...
            <div className="relative p-8 text-center">
              <div className="text-7xl mb-4">💰</div>
              <h3 className="text-4xl font-luckiest-guy text-green-600 mb-3 drop-shadow-md">Sell</h3>
              <p className="text-gray-700 mb-6 text-lg font-medium">
                List your {typeLabel.toLowerCase()} for sale and reach buyers!
              </p>
              <div className="inline-block px-8 py-4 bg-gradient-to-r from-green-500 to-cyan-500 text-white rounded-full font-quicksand font-bold text-lg group-hover:from-green-600 group-hover:to-cyan-600 transition shadow-lg">
                List Shoes →
              </div>
            </div>
          </Link>
